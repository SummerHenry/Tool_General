...
//  UITableView+Gzw.m
//
//  Created by Olmysoft on 17/1/12.
...
{
    objc_setAssociatedObject(self, &imageArr, imageArray, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
...
{
    return objc_getAssociatedObject(self, &imageArr);
}
